...
data modify storage chip8:emu ram[513] set value 7b
data modify storage chip8:emu ram[514] set value 97b
data modify storage chip8:emu ram[515] set value 85b
data modify storage chip8:emu ram[516] set value -128b
data modify storage chip8:emu ram[517] set value 22b
...
execute unless score .temp math matches 42 run tellraw @a [{"text":"Failure: v0 is not 42, but is ",color:red},{"score":{name:".temp",objective:"math"},color:red}]
...
execute if data storage chip8:emu {testpass:1} run tellraw @a {"text":"Test vxyrshift passed! ",color:green}