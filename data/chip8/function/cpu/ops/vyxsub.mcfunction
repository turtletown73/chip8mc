...
execute store result storage chip8:emu arg1 short 1 run scoreboard players get .temp2 math
...
execute if score .temp2 math < .zero math run data modify storage chip8:emu cpu_v_regs[15] set value 0b
execute unless score .temp2 math < .zero math run data modify storage chip8:emu cpu_v_regs[15] set value 1b
