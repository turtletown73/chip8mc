...
execute store result storage global:bitwise arg1 byte 1 run scoreboard players get .temp2 math
data modify storage global:bitwise arg2 set value 1
execute store result storage chip8:emu cpu_v_regs[15] byte 1 run function global:bitwise/byte/and with storage global:bitwise