...
execute store result storage chip8:emu temp byte 1 run function global:bitwise/short/and with storage global:bitwise
execute store result score .temp math run data get storage chip8:emu temp
execute store result storage chip8:emu arg1 short 1 run scoreboard players operation .temp math /= .byte math
execute store result storage chip8:emu temp2 byte 1 run function chip8:cpu/mem/v_reg_read with storage chip8:emu
...
execute store result storage chip8:emu temp3 byte 1 run function chip8:cpu/mem/v_reg_read with storage chip8:emu
...
execute store result storage chip8:emu arg1 byte 1 run function global:bitwise/byte/and with storage global:bitwise
