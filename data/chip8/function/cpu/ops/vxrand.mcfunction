...
execute store result storage global:bitwise arg2 short 1 run function global:bitwise/short/and

execute store result storage global:bitwise arg1 short 1 run random value 0..255
execute store result storage chip8:emu temp2 short 1 run function global:bitwise/short/and
