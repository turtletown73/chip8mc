...
execute store result storage chip8:emu cpu_dt short 1 run scoreboard players get .temp math
...
execute if score .temp math > .zero math run scoreboard players operation .temp math -= .one math
execute store result storage chip8:emu cpu_st short 1 run scoreboard players get .temp math